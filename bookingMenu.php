...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-container" id="services" style="margin-top:75px">
    <h1 class="w3-xxxlarge w3-text-dark-grey"><b>Welcome to EHRUMP Booking Service</b></h1>
    <hr style="width:50px;border:5px solid black" class="w3-round">
    <h3>Choose our service below :</h3>
  </div>
  
  <center><input class="button" type="button" value="E-Hailing" onclick="window.location.href='bookingCatalogue.php'" />
...
<!-- W3.CSS Container -->
<div class="w3-light-grey w3-container w3-padding-32" style="margin-top:75px;padding-right:58px"><p class="w3-right">Powered by <a href="https://www.youtube.com/watch?v=OqS6JXM_TmA&ab_channel=Fernando11101" title="W3.CSS" target="_blank" class="w3-hover-opacity">Holaa</a></p></div>
